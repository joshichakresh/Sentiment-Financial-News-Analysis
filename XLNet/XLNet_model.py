...
from transformers import XLNetForSequenceClassification, AdamW, XLNetTokenizer
...
# Initializing the XLNet tokenizer
...
# Loading pre-trained XLNet model for sequence classification
...
torch.save(model.state_dict(), 'saved_XLNet_model_CUDA.pt')
